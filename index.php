...
<ul class="nav">
<li class="liheader">Presentation</li>
<li class="liheader">Projets</li>
<li class="liheader">connaissances</li>
...
<ul class="nav nav-tabs div2header" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="Presentation-tab" data-bs-toggle="tab" data-bs-target="#Presentation" type="button" role="tab" aria-controls="Presentation" aria-selected="true">Presentation</button>
  </li>
  <li class="nav-item" role="presentation">
